...
check_v2ray_remote_version() {
    ...
    if ! curl -s "https://ghproxy.cn/https://api.github.com/repos/v2fly/v2ray-core/releases/latest" -o "$v2ray_temp_file"; then
    ...
    v2ray_url="https://ghproxy.cn/https://github.com/v2fly/v2ray-core/releases/download/$v2ray_remote_version/v2ray-linux-$v2ray_arch.zip"
...
check_xray_remote_version() {
    ...
    if ! curl -s "https://ghproxy.cn/https://api.github.com/repos/XTLS/Xray-core/releases/latest" -o "$xray_temp_file"; then
    ...
    xray_url="https://ghproxy.cn/https://github.com/XTLS/Xray-core/releases/download/$xray_remote_version/Xray-linux-$v2ray_arch.zip"
    rm -f "$xray_temp_file"
}
...
check_v2raya_remote_version() {
    ...
    if ! curl -s "https://ghproxy.cn/https://api.github.com/repos/v2rayA/v2rayA/releases/latest" -o "$v2raya_temp_file"; then
    ...
    v2raya_url="https://ghproxy.cn/https://github.com/v2rayA/v2rayA/releases/download/${v2raya_remote_version}/v2raya_linux_${v2raya_arch}_${v2raya_short_version}"
...
download_v2raya() {
    ...
    if command -v systemctl >/dev/null 2>&1; then
        service_file_url="https://ghproxy.cn/https://github.com/v2rayA/v2rayA-installer/raw/main/systemd/v2raya.service"
    ...
    if command -v rc-service >/dev/null 2>&1; then
        service_script_url="https://ghproxy.cn/https://github.com/v2rayA/v2rayA-installer/raw/main/openrc/v2raya"
        echo "${GREEN}Downloading v2rayA service file${RESET}"
