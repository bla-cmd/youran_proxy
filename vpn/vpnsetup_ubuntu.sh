...
YOUR_IPSEC_PSK='hm123456'
YOUR_USERNAME='vpnuser1'
YOUR_PASSWORD='hm123456'
...
get_helper_scripts() {
  ...
  base1="https://ghproxy.cn/https://raw.githubusercontent.com/hwdsl2/setup-ipsec-vpn/master/extras"
  base2="https://ghproxy.cn/https://gitlab.com/hwdsl2/setup-ipsec-vpn/-/raw/master/extras"
  sc1=ikev2setup.sh
  sc2=add_vpn_user.sh
  sc3=del_vpn_user.sh
  cd /opt/src || exit 1
...
get_swan_ver() {
  SWAN_VER=5.0
  base_url="https://ghproxy.cn/https://github.com/hwdsl2/vpn-extras/releases/download/v1.0.0"
