...
_constant() {
    ...
    node_set=""
    node_set_1="https://ghproxy.cn/https://raw.githubusercontent.com/i-abc/speedtest/node/all-node.txt"
    node_set_2="https://ghproxy.cn/https://raw.githubusercontent.com/i-abc/speedtest/node/all-node-mirror.txt"
    ...
    speedtest_cli_tar_url_2="https://ghproxy.cn/https://raw.githubusercontent.com/i-abc/speedtest/asset/speedtest-cli/v${speedtest_cli_version}/ookla-speedtest-${speedtest_cli_version}-linux-${speedtest_cli_arch}.tgz"
    ...
    bim_core_tar_url=""
    bim_core_tar_url_1="https://ghproxy.cn/https://github.com/veoco/bim-core/releases/download/v${bim_core_version}/bimc-${bim_core_arch}-unknown-linux-musl"
    bim_core_tar_url_2="https://ghproxy.cn/https://github.com/veoco/bim-core/releases/download/v${bim_core_version}/bimc-${bim_core_arch}-unknown-linux-musl"
    ...
    speedtest_go_tar_url_1="https://ghproxy.cn/https://github.com/showwin/speedtest-go/releases/download/v${speedtest_go_version}/speedtest-go_${speedtest_go_version}_Linux_${speedtest_go_arch}.tar.gz"
    speedtest_go_tar_url_2="https://ghproxy.cn/https://github.com/showwin/speedtest-go/releases/download/v${speedtest_go_version}/speedtest-go_${speedtest_go_version}_Linux_${speedtest_go_arch}.tar.gz"
    ...
    librespeed_cli_tar_url_1="https://ghproxy.cn/https://github.com/librespeed/speedtest-cli/releases/download/v${librespeed_cli_version}/librespeed-cli_${librespeed_cli_version}_linux_${librespeed_cli_arch}.tar.gz"
    librespeed_cli_tar_url_2="https://ghproxy.cn/https://github.com/librespeed/speedtest-cli/releases/download/v${librespeed_cli_version}/librespeed-cli_${librespeed_cli_version}_linux_${librespeed_cli_arch}.tar.gz"
