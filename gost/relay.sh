...
config_content=$(cat <<EOF
{
    ...
    "Routes": [
        ...
        },
        {
            "Retries": 0,
            "ServeNodes": [
                "tcp://:1001/$ip_address:1001",
                "udp://:1001/$ip_address:1001"
            ]
        },
        {
            "Retries": 0,
            "ServeNodes": [
                "tcp://:2345/$ip_address:2345",
                "udp://:2345/$ip_address:2345"
            ]
        }
    ]
}
...
nonencrypt/1001#$ip_address#1001
nonencrypt/2345#$ip_address#2345
EOF
)
...
echo "relay配置已创建并保存到 $config_path"
